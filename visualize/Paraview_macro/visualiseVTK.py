...
tensorGlyph1Display.ScaleTransferFunction.Points = [-89.89864349365234, 0.0, 0.5, 0.0, 89.9757080078125, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tensorGlyph1Display.OpacityTransferFunction.Points = [-89.89864349365234, 0.0, 0.5, 0.0, 89.9757080078125, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
tensorGlyph2Display.ScaleTransferFunction.Points = [0.48617199063301086, 0.0, 0.5, 0.0, 89.98120880126953, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tensorGlyph2Display.OpacityTransferFunction.Points = [0.48617199063301086, 0.0, 0.5, 0.0, 89.98120880126953, 1.0, 0.5, 0.0]
...
xmin, xmax, ymin, ymax, zmin, zmax = tensorGlyph1.GetDataInformation().DataInformation.GetBounds()
...
renderView1.CameraPosition = [33.71678388118744, 33.697817265987396, 200.82274923928756]
renderView1.CameraFocalPoint = [33.71678388118744, 33.697817265987396, 1.0005327090620995]
